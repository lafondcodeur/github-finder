...
function replaceEqualDeep(a, b, depth = 0) {
  ...
  for (let i2 = 0; i2 < bSize; i2++) {
    ...
    if (aItem === bItem) {
      copy[key] = aItem;
      if (array ? i2 < aSize : hasOwn.call(a, key)) equalItems++;
      continue;
    }
...
const fecthGitHubUser = async (username) => {
...
const UserCard = ({ user }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "user-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.avatar_url, alt: user.name, className: "avatar" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: user.name || user.login }),
    user.bio && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "bio", children: user.bio }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaGithubAlt, {}),
          " View Github Profile"
        ]
      }
    )
...
const RecentSearches = ({ users, onSelect }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recent-searches", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "recent-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FaClock, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Recent Searches" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: users.map((user) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FaUser, { className: "user-icon" }),
          user
        ]
      }
    ) }, user)) })
...
function c(e, u, c2, i2) {
  var l2 = this, a = reactExports.useRef(null), o = reactExports.useRef(0), f = reactExports.useRef(0), v = reactExports.useRef(null), d = reactExports.useRef([]), m = reactExports.useRef(), s = reactExports.useRef(), g = reactExports.useRef(e), h = reactExports.useRef(true), x = reactExports.useRef(), E = reactExports.useRef();
  g.current = e;
  var b = "undefined" != typeof window, p = !u && 0 !== u && b;
  if ("function" != typeof e) throw new TypeError("Expected a function");
  u = +u || 0;
  var y = !!(c2 = c2 || {}).leading, w = !("trailing" in c2) || !!c2.trailing, O = !!c2.flushOnExit && w, F = "maxWait" in c2, L = "debounceOnServer" in c2 && !!c2.debounceOnServer, A = F ? Math.max(+c2.maxWait || 0, u) : null, D = reactExports.useMemo(function() {
    var r = function(r2) {
      var n2 = d.current, t2 = m.current;
      return d.current = m.current = null, o.current = r2, f.current = f.current || r2, s.current = g.current.apply(t2, n2);
    }, n = function(r2, n2) {
      p && cancelAnimationFrame(v.current), v.current = p ? requestAnimationFrame(r2) : setTimeout(r2, n2);
    }, t = function(r2) {
      if (!h.current) return false;
      var n2 = r2 - a.current;
      return !a.current || n2 >= u || n2 < 0 || F && r2 - o.current >= A;
    }, e2 = function(n2) {
      return v.current = null, w && d.current ? r(n2) : (d.current = m.current = null, s.current);
    }, c3 = function r2() {
      var c4 = Date.now();
      ...
      if (b || L) {
        ...
        if (d.current = [].slice.call(arguments), m.current = l2, a.current = i3, O && !x.current && (x.current = function() {
          var r2;
          "hidden" === (null == (r2 = global.document) ? void 0 : r2.visibilityState) && E.current.flush();
        }, null == (e3 = global.document) || null == e3.addEventListener || e3.addEventListener("visibilitychange", x.current)), f2) {
          if (!v.current && h.current) return o.current = a.current, n(c3, u), y ? r(a.current) : s.current;
          if (F) return n(c3, u), r(a.current);
        }
    ...
    return S.cancel = function() {
      var r2 = v.current;
      r2 && (p ? cancelAnimationFrame(v.current) : clearTimeout(v.current)), o.current = 0, d.current = a.current = m.current = v.current = null, r2 && i2 && i2({});
  ...
  return E.current = D, reactExports.useEffect(function() {
...
function l(n, t, l2) {
  var a = i, o = reactExports.useRef(n), f = reactExports.useState({})[1], v = c(reactExports.useCallback(function(r) {
    o.current = r, f({});
  }, [f]), t, l2, f), d = reactExports.useRef(n);
...
const SuggestionsDropdown = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "suggestions", children: suggestions.slice(0, 5).map((user) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "li",
    {
      onClick: () => {
        onSelect(user.login);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.avatar_url, alt: user.login, className: "avatar-xs" }),
        user.login
      ]
    },
    user.login
...
const UserSearch = () => {
  ...
  const [submittedUserName, setSubmittedUsername] = reactExports.useState("");
  const [recentUsers, setRecentUsers] = reactExports.useState(() => {
    const stored = localStorage.getItem("recentUsers");
    return stored ? JSON.parse(stored) : [];
  });
  const [debouncedUsername] = l(userName, 300);
  const [showSuggestions, setShowSuggestion] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown-wrapper", children: [
    ...
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "status", children: "Loading..." }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "status error", children: error.message }),
    data && /* @__PURE__ */ jsxRuntimeExports.jsx(UserCard, { user: data }),
    recentUsers.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
      RecentSearches,
      {
        users: recentUsers,
        onSelect: (userName2) => {
          setUsername(userName2);
          setSubmittedUsername(userName2);
        }
      }
    )
  ] });
...
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "GitHub Finder" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(UserSearch, {})
  ] });
};
const queryClient = new QueryClient();
clientExports.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
